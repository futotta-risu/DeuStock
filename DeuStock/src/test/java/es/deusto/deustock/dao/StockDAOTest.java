...
public class StockDAOTest {
    ...
    void testHasOnExistentObject() throws SQLException {
        ...
        when(dbManager.get(eq(DeuStock.class), anyList())).thenReturn(stock);
    ...
    void testHasOnNonExistentObject() throws SQLException {
        // Given
        when(dbManager.get(eq(DeuStock.class), anyList())).thenReturn(null);
    ...
    void testDelete() throws SQLException {
        // Given
        DeuStock stock = new DeuStock("TestSymbol");
        doNothing().when(dbManager).delete(eq(DeuStock.class), anyList());
