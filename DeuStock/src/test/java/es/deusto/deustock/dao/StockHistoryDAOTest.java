...
public class StockHistoryDAOTest {
    ...
    void testGetOnExistentObject() throws SQLException {
        ...
        when(dbManager.getByID(eq(StockHistory.class), anyString())).thenReturn(stockHistory);
    ...
    void testGetOnNonExistentObject() throws SQLException {
        // Given
        when(dbManager.getByID(eq(StockHistory.class), anyString())).thenReturn(null);
    ...
    void testGetStockHistoryFromWalletId() throws SQLException {
        ...
        when(dbManager.getList(eq(StockHistory.class), anyList())).thenReturn(stockHistoryList);
